        ...
        success:function (data) {
            if (data.code == 200){
                ...
                if (data.code == 2003){
                    ...
                    if (isAccepted){
                        window.open("https://github.com/login/oauth/authorize?client_id=9649e173e7bd06cf074b&redirect_uri=http://39.99.201.82:7040/callback&scope=user&state=1");
